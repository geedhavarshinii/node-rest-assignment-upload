...
router.get("/:assignmentId", checkAuth, (req, res, next) => {
  Answer.find({ assignment: req.params.assignmentId })
...
router.post("/", checkAuth, upload.single("answerPaper"), (req, res, next) => {
